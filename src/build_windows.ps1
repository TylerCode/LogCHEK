...
./rcedit.exe LogCHEK-GUI.exe --set-file-version "0.3.1.0"
./rcedit.exe LogCHEK-GUI.exe --set-product-version "0.3.1.0"
...
./rcedit.exe LogCHEK.exe --set-file-version "0.3.1.0"
./rcedit.exe LogCHEK.exe --set-product-version "0.3.1.0"
