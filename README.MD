...
Building on Windows ARM requires a different compiler toolchain. **See [BUILDING_WINDOWS_ARM.md](BUILDING_WINDOWS_ARM.md) for detailed instructions.**

Quick start:
1. Download and install llvm-mingw for ARM64
